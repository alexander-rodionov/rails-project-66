...
# module Stubs
#   def self.generate_fake_github_user
...
#   def self.generate_fake_github_repo(owner_login = nil)
...
#   def self.generate_fake_languages
#     [{ Ruby: 16_362, Shell: 131, Makefile: 29 }]
#   end

#   def self.generate_fake_github_commit
...
#   def self.generate_fake_github_hooks_response
